    ...
    <div className="flex h-screen w-full flex-col overflow-hidden rounded-xl bg-background">
      ...
      <Toaster
        ...
        toastOptions={{
          classNames: {
            toast:
              'group toast group-[.toaster]:bg-card group-[.toaster]:text-foreground group-[.toaster]:border-border/60 group-[.toaster]:shadow-sm',
            description: 'group-[.toast]:text-muted-foreground text-sm',
            actionButton:
              'group-[.toast]:bg-primary group-[.toast]:text-primary-foreground text-sm font-medium',
            cancelButton:
              'group-[.toast]:bg-muted group-[.toast]:text-muted-foreground text-sm',
          },
        }}
      />
    </div>
