...
import { Users, Plus, Cloud } from 'lucide-react'
...
export function CohortList() {
  ...
  const handleOpenAttioBrowser = () => {
    useUIStore.getState().setAttioBrowserOpen(true)
  }
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-0.5">
          <Button
            ...
            size="icon"
            className="size-6"
            onClick={handleOpenAttioBrowser}
            title={t('cohorts.importFromAttio')}
          >
